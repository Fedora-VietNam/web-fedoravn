...
/**
 * @brief Renders a group of items in the sidebar.
 */
...
/**
 * @brief Renders a label for a sidebar group.
 */
...
/**
 * @brief Renders an action button for a sidebar group.
 */
...
/**
 * @brief Renders the content area of a sidebar group.
 */
